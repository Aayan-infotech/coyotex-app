...
//   void _handleMarkerArrival(LatLng currentPosition, double? speed) {
//     if (currentMarkerIndex >= selectedTripModel.markers.length) return;

//     final currentMarker = selectedTripModel.markers[currentMarkerIndex];
//     final distanceToMarker = Geolocator.distanceBetween(
//       currentPosition.latitude,
//       currentPosition.longitude,
...
//     if (distanceToMarker <= _calculate5MinuteDistance(speed) &&
//         !hasSentArrivalNotification) {
//       //  _sendNotification("5 minutes until arrival");
//       //  hasSentArrivalNotification = true;
//     }

//     // Arrival detection (50 meters)
//     if (distanceToMarker <= 50) {
//       // _handleMarkerArrivalLogic(currentMarker);
//     }
//   }
